...
principle_investment = float(input("What's the principle investment?: "))
rate_prompt = float(input("What's the interest rate?: "))
number_of_times = float(input("What's the number of times that interest is compounded per unit?: "))
...
print("This is the value of the account at this date: ",compound_formula)